library flutter_bloc_monitor;

import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_bloc_monitor/error_info.dart';
import 'package:flutter_bloc_monitor/transition_info.dart';

import 'event_info.dart';

class FlutterMonitor extends BlocDelegate {
  FlutterMonitor({this.onErrorFunc, this.onEventFunc, this.onTransitionFunc});
